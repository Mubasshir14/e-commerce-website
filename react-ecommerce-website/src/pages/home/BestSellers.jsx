    ...
    return (
        <div className='max-w-screen-2xl container mx-auto xl:px-28 px-4'>
            <div className='text-center'>
                ...
                <p className='text-Black/75 capitalize md:w-2/3 mx-auto mb-8'>Explore our top-rated products, loved by customers! From gadgets to fashion, discover items with rave reviews and high demand. Shop now and see why they're flying off the shelves!</p>
            </div>
